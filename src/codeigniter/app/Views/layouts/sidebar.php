    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <?php if (session()->get('fk_roles') == 1) : ?>
            <li class="nav-item mt-3">
                <small class="text-uppercase text-muted fw-bold" style="font-size: 0.7rem;">Menu Admin</small>
            </li>
            <li class="nav-item mt-2">
                <a href="<?= base_url('admin/roles') ?>" class="nav-link <?= (uri_string() == 'admin/roles') ? 'active' : 'text-dark' ?>">
                    <i class="bi bi-person-badge me-2"></i> Kelola Roles
                </a>
            </li>
            <li class="nav-item mt-2">
        ...
        <?php if (session()->get('fk_roles') == 5) : ?>
            ...
            <li class="nav-item mt-1">
                <a href="<?= base_url('univ/monitoring/akreditasi') ?>" class="nav-link <?= (uri_string() == 'univ/monitoring/akreditasi') ? 'active' : 'text-dark' ?>">
                    <i class="bi bi-patch-check me-2"></i> Monitoring Akreditasi
                </a>
            </li>
        <?php endif; ?>
    </ul>
